...
export function HeatmapCard({
  ...
  const maxCount =
    data.length > 0 ? Math.max(1, ...data.map((d) => d.count)) : 1;
  ...
  const rowHeight = Math.max(
    6,
    (height - dayLabelHeight - legendHeight - headerGap * 2 - totalRowGaps) /
      24,
  );
  ...
  return (
    ...
    >
      <div>
        <div
          style={{ fontSize: 16, fontWeight: 600, color: theme.primaryText }}
        >
          {title}
        </div>
        {subtitle && (
          <div
            style={{ fontSize: 12, color: theme.secondaryText, marginTop: 2 }}
          >
            {subtitle}
          </div>
        )}
          ...
          >
            {HOURS.map((hour) => (
              ...
              >
                ...
                <div
                  style={{ flex: 1, display: "flex", gap: colGap, minWidth: 0 }}
                >
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 2,
                          border:
                            level === 0 ? `1px solid ${theme.divider}` : "none",
                        }}
                      />
                    );
                  })}
        ...
        {LEVEL_COLORS.map((c, i) => (
          <div
            ...
            style={{
              ...
              backgroundColor: c,
              borderRadius: 2,
              border: i === 0 ? `1px solid ${theme.divider}` : "none",
            }}
          />
        ))}
        <span>Más</span>
