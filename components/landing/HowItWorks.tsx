...
const TESTIMONIALS = [
  {
    text: "Antes manejábamos el inventario en Excel y siempre teníamos errores de conteo. Con Tu Cuadre, ahora cada movimiento queda registrado y las alertas de stock mínimo nos han salvado más de una vez.",
